...
// validaciones
  ...
  //     $miArchivo=dirname(_FILE_). "/" . "archivos_subidos/$id." . $ext;
  //   }else{
  //     $extArchivoError=true;
  //   }
  // }
// guardamos los datos en el json quitado  && !$extArchivoError && !$emptyInterestError
  if (!$emptyNameError && !$invalidEmailError  && !$notSetPasswordError) {
    /*
