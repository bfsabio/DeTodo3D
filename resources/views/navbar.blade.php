...
<body>
        <nav class="navbar navbar-expand-lg navbar-dark" id="color" >  <!-- bg-dark -->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto" >
            <li  class="nav-item"><a id="text"  class="nav-link @if(Request::is('login'))disabled @endif" href="login">Ingresar <span class="sr-only">(current)</span></a></li>
