    ...
    <!-- IMAGENES DE LA EMPRESA -->
      ...
      <div class="container col-md-12">
        <div class="row text-center">
          ...
          <div class="col-md-3 imagenes">
            <img src="img/insumos2.jpg" alt="empresa" width="200" height="200">  <!-- PHP EMBEBIDO DONDE SE MUESTRE 1 imagen -->
          </div>
          <div class="col-md-3 imagenes">
            <img src="img/insumos3.jpg" alt="empresa" width="200" height="200">  <!-- PHP EMBEBIDO DONDE SE MUESTRE 1 imagen -->
          </div>
          <div class="col-md-3 imagenes">
            <img src="img/insumos4.jpg" alt="empresa" width="200" height="200">  <!-- PHP EMBEBIDO DONDE SE MUESTRE 1 imagen -->
          </div>
        </div>
      </div>
      </section>
