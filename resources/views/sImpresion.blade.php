      ...
      <div class="container col-md-12">
        <div class="row text-center">
          <div class="col-md-3 imagenes">
            <img src="img/impresion.jpg" alt="impresion" width="200" height="200">  <!-- PHP EMBEBIDO DONDE SE MUESTRE 1 imagen -->
          </div>
          <div class="col-md-3 imagenes">
            <img src="img/impresion2.jpg" alt="impresion" width="200" height="200">  <!-- PHP EMBEBIDO DONDE SE MUESTRE 1 imagen -->
          </div>
          <div class="col-md-3 imagenes">
            <img src="img/impresion3.jpg" alt="impresion" width="200" height="200">  <!-- PHP EMBEBIDO DONDE SE MUESTRE 1 imagen -->
          </div>
          <div class="col-md-3 imagenes">
            <img src="img/impresion4.jpg" alt="impresion" width="200" height="200">  <!-- PHP EMBEBIDO DONDE SE MUESTRE 1 imagen -->
          </div>
        </div>
      </div>
      </section>
