...
<div class="container col-md-24">
  ...
  <div class="text-center col-md-1">
    ...
    <div class="text-left col-md-12">
      <p class="texto">Mis datos:</p><br> <!-- PHP EMBEBIDO DONDE SE MUESTRE EL NOMBRE DE LA EMPRESA -->
      <p class="texto">email:...</p><br>
      <p class="texto">contraseña:...</p><br>
      <p class="texto">celular:...</p><br>
      <p class="texto">direcion:...</p>
    </div>
